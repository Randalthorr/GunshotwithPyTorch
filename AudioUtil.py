...
class AudioUtil():
    ...
    def spectro_gram(aud, n_mels=128, n_fft=1024, hop_len=None):
        ...
        spec = transforms.MelSpectrogram(sr, n_fft=n_fft, hop_length=hop_len, n_mels=n_mels, f_min=500)(sig)
...
def showMelSpectrogram(data, rate, n_mels=128, hop_length=500, window='hann', title='Mel-frequency spectrogram'):
    spectrogram = data
